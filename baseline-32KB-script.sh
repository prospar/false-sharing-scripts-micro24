...
echo  "Running applications with the 32KB baseline"
echo "take as parameter protocol and number of trials"
if [ $1 ];
then
    ...
    # echo "PARSEC kernels for 32KB baseline completed"
    # python3 src/main.py --tasks run --trials $2 --bench blackscholes --verbose 1 --protocol MESI_Nonblocking --workloadSize large  --outputDir micro-baseline-32KB --benchmark_type parsec
    # python3 src/main.py --tasks run --trials $2 --bench bodytrack --verbose 1 --protocol MESI_Nonblocking --workloadSize large  --outputDir micro-baseline-32KB --benchmark_type parsec
    # python3 src/main.py --tasks run --trials $2 --bench facesim --verbose 1 --protocol MESI_Nonblocking --workloadSize large  --outputDir micro-baseline-32KB --benchmark_type parsec
    # python3 src/main.py --tasks run --trials $2 --bench fluidanimate --verbose 1 --protocol MESI_Nonblocking --workloadSize large --outputDir micro-baseline-32KB --benchmark_type parsec
    # python3 src/main.py --tasks run --trials $2 --bench swaptions --verbose 1 --protocol MESI_Nonblocking --workloadSize large --outputDir micro-baseline-32KB --benchmark_type parsec
    # echo "PARSEC apps for 32KB baseline completed"
else
