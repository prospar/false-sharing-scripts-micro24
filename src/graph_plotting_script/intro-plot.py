...
PATH_CSV = "/home/vipin/Documents/false-sharing-result/micro-2024-result/result/introduction/Stats_Avg.csv"
...
def plot_time():
  ...
  plot_data(fs_norm_times, man_fix_norm_times, "Speedup", "plot-run-time.pdf")
