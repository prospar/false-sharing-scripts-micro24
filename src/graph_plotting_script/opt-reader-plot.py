...
PATH_CSV = "/home/vipin/Documents/false-sharing-result/micro-2024-result/result/micro-opt-reader/Stats_Avg.csv"
...
def plot_time():
  ...
  plot_data(repair_norm_times, repair_sam_norm_times, "Speedup", "opt-reader-run-time.pdf")
...
def plot_energy():
  ...
  for bench in BENCH_NAMES:
    ...
    bench_repair_optenergy = bench_data[bench_repair][KEY_ENERGY_SAM]
    ...
    repair_abs_energy.append(bench_repair_pamenergy + bench_repair_optenergy
